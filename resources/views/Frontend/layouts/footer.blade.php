<footer class="page-footer font-small unique-color-dark bg-dark mt-xl-5">

    <div style="background-color: #9ccbf7;">
      <div class="container ">
    ...
    <!-- Footer Links -->
    <div class="container text-center text-md-left mt-5 bg-dark">
    ...
    <div class="footer-copyright text-center py-3 text-light">© 2021 Copyright:
      <a class="text-light" href="{{ url('/') }}">Shopanmart</a>
    </div>
    <!-- Copyright -->
